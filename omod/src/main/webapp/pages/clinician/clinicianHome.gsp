...
<div class="ke-page-content">
	${ ui.includeFragment("kenyaemr", "patient/patientList", [ id: "results", showNumResults: true, pageProvider: "kenyaemr", page: "clinician/clinicianViewPatient", heading: "Matching Patients"]) }
</div>
