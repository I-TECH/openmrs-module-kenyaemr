...
public class MchEnrollmentSummaryFragmentController {
	...
	public String controller(@FragmentParam("patientProgram") PatientProgram enrollment,
		...
		Obs o = EmrUtils.firstObsInProgram(enrollment, Dictionary.getConcept("161655AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"));//TODO: Add ANC Concept ID to Dictionary
		if (o != null) {
			dataPoints.put("ANC No. ", o.getValueNumeric());
		}
