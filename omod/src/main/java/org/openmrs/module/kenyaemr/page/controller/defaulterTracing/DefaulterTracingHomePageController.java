...
public class DefaulterTracingHomePageController {
	...
	public String controller(UiUtils ui, PageModel model) {
		...
		if (patient != null) {
			return "redirect:" + ui.pageLink(EmrConstants.MODULE_ID, "defaulterTracing/defaulterTracingViewPatient", SimpleObject.create("patientId", patient.getId()));
		} else {
			return null;
		}
	}
