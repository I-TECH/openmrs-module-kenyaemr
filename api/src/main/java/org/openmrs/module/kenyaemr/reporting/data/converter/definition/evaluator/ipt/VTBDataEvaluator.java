...
/**
 * Evaluates a VTBDataDefinition
 */
@Handler(supports= VTBDataDefinition.class, order=50)
public class VTBDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select init.patient_id, do.dose from kenyaemr_etl.etl_ipt_initiation init left outer join openmrs.orders o on init.patient_id = o.patient_id\n" +
                ...
                "where o.concept_id = 82913 and date(init.visit_date) between date(:startDate) and date(:endDate) and init.voided = 0 group by init.patient_id having max(o.date_activated);";
