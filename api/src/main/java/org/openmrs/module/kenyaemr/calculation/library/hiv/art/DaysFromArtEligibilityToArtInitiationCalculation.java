...
public class DaysFromArtEligibilityToArtInitiationCalculation extends AbstractPatientCalculation {
    ...
    public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> params, PatientCalculationContext context) {
        ...
        CalculationResultMap allWhoStage = Calculations.allObs(org.openmrs.module.kenyaemr.Dictionary.getConcept(org.openmrs.module.kenyaemr.Dictionary.CURRENT_WHO_STAGE), cohort, context);
        CalculationResultMap allCd4 = Calculations.allObs(org.openmrs.module.kenyaemr.Dictionary.getConcept(org.openmrs.module.kenyaemr.Dictionary.CD4_COUNT), cohort, context);
        CalculationResultMap artStartDateMap = calculate(new InitialArtStartDateCalculation(), cohort, context);
        //find hepatits status
        CalculationResultMap hepatitisMap = Calculations.lastObs(org.openmrs.module.kenyaemr.Dictionary.getConcept(org.openmrs.module.kenyaemr.Dictionary.PROBLEM_ADDED), cohort, context);

        //find pregnant women
        CalculationResultMap pregStatusObss = Calculations.lastObs(org.openmrs.module.kenyaemr.Dictionary.getConcept(org.openmrs.module.kenyaemr.Dictionary.PREGNANCY_STATUS), female, context);
        //finding those at risk for hiv
        CalculationResultMap hivRiskFactor = Calculations.lastObs(org.openmrs.module.kenyaemr.Dictionary.getConcept(org.openmrs.module.kenyaemr.Dictionary.HIV_RISK_FACTOR), cohort, context);

        //find those who have status for tb
        CalculationResultMap tbStatus = Calculations.lastObs(org.openmrs.module.kenyaemr.Dictionary.getConcept(org.openmrs.module.kenyaemr.Dictionary.TUBERCULOSIS_DISEASE_STATUS), cohort, context);
        ...
        for(Integer ptId: cohort) {
            ...
            if(hivEnrollment != null) {
                hivEnrollmentDate = hivEnrollment.getDateEnrolled();
            }
            Date artInitialDate = EmrCalculationUtils.datetimeResultForPatient(artInitiationDate, ptId);

            if(inHivProgram.contains(ptId) && artInitialDate != null && hivEnrollmentDate != null){
                ...
                if (inHivProgram.contains(ptId) && pregnancyObs != null && pregnancyObs.getValueCoded().equals(org.openmrs.module.kenyaemr.Dictionary.getConcept(org.openmrs.module.kenyaemr.Dictionary.YES)) && pregnancyObs.getObsDatetime().before(futureDate)) {
                ...
                } else if (inHivProgram.contains(ptId) && hepatitisConcept != null && hepatitisConcept.getValueCoded().equals(org.openmrs.module.kenyaemr.Dictionary.getConcept(org.openmrs.module.kenyaemr.Dictionary.HEPATITIS_B)) && hepatitisConcept.getObsDatetime().before(futureDate)) {
                ...
                } else if ((inHivProgram.contains(ptId) && inTbProgram.contains(ptId) || (hasTbConcpt != null && hasTbConcpt.getValueCoded().equals(org.openmrs.module.kenyaemr.Dictionary.getConcept(org.openmrs.module.kenyaemr.Dictionary.DISEASE_DIAGNOSED))) || (hasTbConcpt != null && hasTbConcpt.getValueCoded().equals(org.openmrs.module.kenyaemr.Dictionary.getConcept(org.openmrs.module.kenyaemr.Dictionary.ON_TREATMENT_FOR_DISEASE)))) && hasTbConcpt.getObsDatetime().before(futureDate)) {
                ...
                } else if (inHivProgram.contains(ptId) && isDiscodantCouple != null && isDiscodantCouple.getValueCoded().equals(org.openmrs.module.kenyaemr.Dictionary.getConcept(org.openmrs.module.kenyaemr.Dictionary.DISCORDANT_COUPLE)) && isDiscodantCouple.getObsDatetime().before(futureDate)) {
