...
/**
 * Evaluates Current HEI Dewormed Data Definition
 */
@Handler(supports=HEICWMNPSupplimentationDataDefinition.class, order=50)
public class HEICWCMNPSupplimentationDataEvaluator implements EncounterDataEvaluator {
