...
/**
 * Evaluates a HTSRiskDoneDataDefinition to produce a VisitData
 */
@Handler(supports=HTSRiskDoneDataDefinition.class, order=50)
public class HTSRiskDoneDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select e.encounter_id, 'Yes'\n" +
