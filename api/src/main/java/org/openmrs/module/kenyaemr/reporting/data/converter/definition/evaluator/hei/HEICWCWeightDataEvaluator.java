...
/**
 * Evaluates Current HEI Weight Data Definition
 */
@Handler(supports=HEICWCWeightDataDefinition.class, order=50)
public class HEICWCWeightDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select hf.encounter_id,tr.weight from kenyaemr_etl.etl_patient_triage tr\n" +
