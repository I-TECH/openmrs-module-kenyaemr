...
/**
 * ART First Switch Data Evaluator Column
 */
@Handler(supports=ARTFirstSwitchDataDefinition.class, order=50)
public class ARTFirstSwitchDataEvaluator implements PersonDataEvaluator {
