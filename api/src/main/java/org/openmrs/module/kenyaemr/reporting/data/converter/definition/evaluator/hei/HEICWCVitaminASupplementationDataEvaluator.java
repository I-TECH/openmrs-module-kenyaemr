...
/**
 * Evaluates Current HEI Vitamin A Supplementation Data Definition
 */
@Handler(supports=HEICWCVitaminASupplementationDataDefinition.class, order=50)
public class HEICWCVitaminASupplementationDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select encounter_id,\n" +
                     ...
                     " when 1066 then \"No\" else \"\" end) as vitaminA_given from kenyaemr_etl.etl_hei_follow_up_visit;";
