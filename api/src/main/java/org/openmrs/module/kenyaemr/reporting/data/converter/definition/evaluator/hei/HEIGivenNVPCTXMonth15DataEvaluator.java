...
public class HEIGivenNVPCTXMonth15DataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select  f.patient_id,\n" +
                "  CONCAT( case f.nvp_given when 80586 then \"Yes\" else \"No\" end,'____________', case f.ctx_given when 105281 then \"Yes\" else \"No\" end) as givenCTXorNVP_fifteen_months\n" +
