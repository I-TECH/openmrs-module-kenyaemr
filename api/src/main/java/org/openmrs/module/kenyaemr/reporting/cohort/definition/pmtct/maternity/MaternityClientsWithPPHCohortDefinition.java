...
public class MaternityClientsWithPPHCohortDefinition extends BaseQuery<Encounter> implements EncounterQuery {

    @ConfigurationProperty
    private Date asOfDate;

    public MaternityClientsWithPPHCohortDefinition() {
    }
