...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.anc.ANCPPFPCounseledDataDefinition;
...
/**
 * Evaluates PPFP Method Counseled Evaluator
 */
@Handler(supports= ANCPPFPCounseledDataDefinition.class, order=50)
public class ANCPPFPCounseledDataEvaluator implements EncounterDataEvaluator {
