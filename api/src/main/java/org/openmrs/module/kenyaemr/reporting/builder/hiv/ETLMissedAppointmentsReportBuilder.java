...
import org.openmrs.module.kenyaemr.calculation.library.NumberOfDaysLateRefillOrClinicalAppCalculation;
import org.openmrs.module.kenyaemr.calculation.library.TelephoneNumberCalculation;
import org.openmrs.module.kenyaemr.calculation.library.hiv.LastClinicalOrRefillReturnVisitDateCalculation;
...
public class ETLMissedAppointmentsReportBuilder extends AbstractHybridReportBuilder {
	...
	protected void addColumns(HybridReportDescriptor report, PatientDataSetDefinition dsd) {
		...
		dsd.addColumn("Last HIV Appointment date", new CalculationDataDefinition("Appointment date", new LastClinicalOrRefillReturnVisitDateCalculation()), "", new DataConverter[]{new CalculationResultConverter()});
		dsd.addColumn("Type of appointment missed", new MissedAppointmentTypeDataDefinition(),"");
		dsd.addColumn("Number of days late", new CalculationDataDefinition("Number of days late", new NumberOfDaysLateRefillOrClinicalAppCalculation()), "", new DataConverter[]{new CalculationResultConverter()});
