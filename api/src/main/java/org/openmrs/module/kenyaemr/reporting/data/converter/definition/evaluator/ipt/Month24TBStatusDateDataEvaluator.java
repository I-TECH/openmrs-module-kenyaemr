...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.ipt.Month24TBStatusDateDataDefinition;
...
public class Month24TBStatusDateDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "Select init.patient_id,COALESCE(concat_ws('\\r\\n',fup.tb_status,max(fup.visit_date)),concat_ws('\\r\\n',tbs.resulting_tb_status,max(tbs.visit_date))) as tb_status_date_m6 from kenyaemr_etl.etl_ipt_initiation init\n" +
                ...
                "where d.program_name = \"IPT\"  and timestampdiff(DAY ,COALESCE(fup.visit_date,tbs.visit_date),d.visit_date) between 690 and 750\n" +
