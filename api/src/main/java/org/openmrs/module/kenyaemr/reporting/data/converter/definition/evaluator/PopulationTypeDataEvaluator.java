...
public class PopulationTypeDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, \n" +
                "(case o.value_coded when 1066 then \"General Population\" when 1065 then \"Key Population\" else \"\" end) population_type\n" +
                "from visit v \n" +
