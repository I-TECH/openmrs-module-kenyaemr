...
public class ArvDrugReportBuilder extends BaseIndicatorReportBuilder{
	...
	protected List<DataSetDefinition> buildDataSets()  {
		log.debug("Setting up report definition");
			...
			return Arrays.asList(artDataSet());
	}
	 ...
	 * @return the dataset
	 */
	protected DataSetDefinition artDataSet() {
		...
		ColumnParameters children =new ColumnParameters(null, "<15", "age=<15");
		ColumnParameters adults =new ColumnParameters(null, "15+", "age=15+");

		String indParams = "startDate=${startDate},endDate=${endDate}";

		dsd.addColumn("AZT-3TC-NVP-A", "Adults patients having (AZT-3TC-NVP) regimen",  ReportUtils.map(ArvReportIndicatorLibrary.onRegimenAzt3tcNvp(),indParams) , "" );
