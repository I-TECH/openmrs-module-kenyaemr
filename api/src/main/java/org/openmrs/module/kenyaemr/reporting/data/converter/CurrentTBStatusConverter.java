...
public class CurrentTBStatusConverter implements DataConverter{
	private String question;

	public CurrentTBStatusConverter(String question) {
	...
	public Object convert(Object obj) {
		...
		TBStatus status = (TBStatus) value;
		if (status == null) {
			return "";
		}

		if (question.equals("status")){
			return status.isOnTreatment()? "Y" : "N";

		} else if (question.equals("startDate")) {
			return formatDate(status.getTreatmentStartDate());
		}
