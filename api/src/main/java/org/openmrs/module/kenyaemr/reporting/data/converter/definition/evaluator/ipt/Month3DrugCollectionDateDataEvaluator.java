...
public class Month3DrugCollectionDateDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select init.patient_id, date(o.date_activated) as month3_refill from kenyaemr_etl.etl_ipt_initiation init left outer join openmrs.orders o on init.patient_id = o.patient_id\n" +
                "                                                                                                          inner join openmrs.drug_order do on o.order_id = do.order_id\n" +
                "where o.concept_id = 78280 and o.date_activated between date_add(o.date_activated,INTERVAL 61 DAY) and date_add(o.date_activated,INTERVAL 90 DAY)\n" +
