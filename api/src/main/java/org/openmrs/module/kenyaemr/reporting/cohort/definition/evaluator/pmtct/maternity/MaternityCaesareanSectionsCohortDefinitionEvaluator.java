...
/**
 * Evaluator for clients who had caesarean section deliveries
 */
@Handler(supports = {CaesareanSectionsCohortDefinition.class})
public class MaternityCaesareanSectionsCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
        ...
        CaesareanSectionsCohortDefinition definition = (CaesareanSectionsCohortDefinition) cohortDefinition;
        String query ="select ld.patient_id from kenyaemr_etl.etl_mchs_delivery ld where ld.mode_of_delivery =1171;";
        ...
        Cohort caesareanSection = Context.getService(CohortDefinitionService.class).evaluate(sqlCohortDefinition, context);


        return new EvaluatedCohort(caesareanSection, definition, context);
    }
