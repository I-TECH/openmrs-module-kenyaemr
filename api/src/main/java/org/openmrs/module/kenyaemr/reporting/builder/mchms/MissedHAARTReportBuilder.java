...
@Component
@Builds({ "kenyaemr.mchms.report.missedHAARTReport" })
public class MissedHAARTReportBuilder extends AbstractReportBuilder {
	...
	protected List<Mapped<DataSetDefinition>> buildDataSets(ReportDescriptor descriptor, ReportDefinition report) {
		return Arrays.asList(ReportUtils.map(missedHAARTDataSetDefinition(), "startDate=${startDate},endDate=${endDate}"));
	...
	protected DataSetDefinition missedHAARTDataSetDefinition() {
		...
		MissedHAARTCohortDefinition cd = new MissedHAARTCohortDefinition();
