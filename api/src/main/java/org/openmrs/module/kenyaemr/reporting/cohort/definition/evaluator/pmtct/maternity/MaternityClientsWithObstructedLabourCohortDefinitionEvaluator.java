...
public class MaternityClientsWithObstructedLabourCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
        ...
        Cohort clientsWithObstructedLabour = Context.getService(CohortDefinitionService.class).evaluate(sqlCohortDefinition, context);


        return new EvaluatedCohort(clientsWithObstructedLabour, definition, context);
    }
