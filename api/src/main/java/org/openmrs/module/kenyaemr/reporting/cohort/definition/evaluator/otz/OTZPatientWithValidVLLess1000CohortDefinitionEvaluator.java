 ...
 */
@Handler(supports = {OTZPatientsWithValidVLLess1000CohortDefinition.class})
public class OTZPatientWithValidVLLess1000CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
        ...
        OTZPatientsWithValidVLLess1000CohortDefinition definition = (OTZPatientsWithValidVLLess1000CohortDefinition) cohortDefinition;
        Integer month = definition.getMonth();
        CohortDefinition cd = otzCohortLibrary.patientWithValidVLLess1000();
        ...
        Cohort patientVlLess1000 = Context.getService(CohortDefinitionService.class).evaluate(cd, context);


        return new EvaluatedCohort(patientVlLess1000, definition, context);
    }
}
