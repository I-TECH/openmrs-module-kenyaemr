...
public class CACXScreeningResultsDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select patient_id, mid(max(concat(visit_date,screening_result)),11) as screening_result from kenyaemr_etl.etl_cervical_cancer_screening GROUP BY patient_id;";
