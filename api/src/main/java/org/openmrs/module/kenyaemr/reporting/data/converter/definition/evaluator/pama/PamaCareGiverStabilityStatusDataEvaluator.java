 ...
 */
@Handler(supports= PamaCareGiverStabilityStatusDataDefinition.class, order=50)
public class PamaCareGiverStabilityStatusDataEvaluator implements PersonDataEvaluator {
