 ...
 */
public class LastClinicalOrRefillReturnVisitDateCalculation extends AbstractPatientCalculation {

    @Override
    public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> map, PatientCalculationContext context) {

        Integer latestTCA = 5096;
        Integer latestRefillDate = 162549;
        ...
        for (Integer ptId : cohort) {
            ...
            if (lastFollowUpEncounter != null) {
                Date refillDate = null, tcaDate = null;
