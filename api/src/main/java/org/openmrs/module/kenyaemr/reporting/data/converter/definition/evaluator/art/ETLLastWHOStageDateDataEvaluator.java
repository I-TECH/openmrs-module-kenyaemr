...
/**
 * Evaluates Last WHO Stage Date Data Definition
 */
@Handler(supports= ETLLastWHOStageDateDataDefinition.class, order=50)
public class ETLLastWHOStageDateDataEvaluator implements PersonDataEvaluator {
