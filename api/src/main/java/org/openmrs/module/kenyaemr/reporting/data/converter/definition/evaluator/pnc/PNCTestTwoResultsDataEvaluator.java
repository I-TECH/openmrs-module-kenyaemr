...
public class PNCTestTwoResultsDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.encounter_id,\n" +
                "       CONCAT_WS ('\\n',v.test_2_kit_name,'____________',v.test_2_kit_lot_no,'____________',v.test_2_kit_expiry,'____________',(case v.test_2_result  when 664 then \"Negative\" when 703 then \"Positive\"\n" +
