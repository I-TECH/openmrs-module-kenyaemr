...
import org.openmrs.module.kenyaemr.calculation.library.mchms.MissedLastAppointmentCalculation;
...
@Component
@Builds({"kenyaemr.mchcs.report.defaulter"})
public class defaulterReportBuilder extends AbstractHybridReportBuilder{

	@Override
	protected Mapped<CohortDefinition> buildCohort(HybridReportDescriptor descriptor, PatientDataSetDefinition dsd) {
		return defaultersInCWCCohort();

	}
	
	protected Mapped<CohortDefinition> defaultersInCWCCohort() {
		CohortDefinition cd = new CalculationCohortDefinition(new MissedLastAppointmentCalculation());
    ...
    protected List<Mapped<DataSetDefinition>> buildDataSets(ReportDescriptor descriptor, ReportDefinition report) {
        ...
        PatientDataSetDefinition vaccinationAppointmentsPDSD = vaccinationAppointmentsDataSetDefinition("defaulter");
        vaccinationAppointmentsPDSD.addRowFilter(defaultersInCWCCohort());
