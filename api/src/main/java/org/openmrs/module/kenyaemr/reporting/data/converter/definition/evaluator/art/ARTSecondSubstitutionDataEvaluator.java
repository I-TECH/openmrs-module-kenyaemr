...
/**
 * ART Second Substitution Data Evaluator Column
 */
@Handler(supports=ARTSecondSubstitutionDataDefinition.class, order=50)
public class ARTSecondSubstitutionDataEvaluator implements PersonDataEvaluator {
