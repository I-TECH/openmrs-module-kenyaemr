 ...
 */
public class NumberOfDaysLateRefillOrClinicalAppCalculation extends AbstractPatientCalculation {
    @Override
    public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> map, PatientCalculationContext context) {

        CalculationResultMap ret = new CalculationResultMap();
        CalculationResultMap returnDate = calculate(new LastClinicalOrRefillReturnVisitDateCalculation(), cohort, context);
