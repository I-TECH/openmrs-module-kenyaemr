...
/**
 * Evaluator for patients given ITN at ANC
 */
@Handler(supports = {GivenIPT1ANCCohortDefinition.class})
public class GivenIPT1ANCCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		GivenIPT1ANCCohortDefinition definition = (GivenIPT1ANCCohortDefinition) cohortDefinition;
		String qry = "select\n" +
		...
		Cohort giveIPT1ANC = Context.getService(CohortDefinitionService.class).evaluate(sqlCohortDefinition, context);


		return new EvaluatedCohort(giveIPT1ANC, definition, context);
	}
}
