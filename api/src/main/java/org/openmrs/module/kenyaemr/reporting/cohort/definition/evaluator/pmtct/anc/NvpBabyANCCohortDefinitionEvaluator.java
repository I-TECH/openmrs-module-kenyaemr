...
/**
 * Evaluator for nvp for baby in ANC
 */
@Handler(supports = {NvpBabyANCCohortDefinition.class})
public class NvpBabyANCCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		NvpBabyANCCohortDefinition definition = (NvpBabyANCCohortDefinition) cohortDefinition;
		if (definition == null)
			return null;
		...
		String qry = "select distinct v.patient_id\n" +
				...
				"                      and v.baby_nvp_dispensed = 160123;";
		...
		Cohort nvpForBabyANC = Context.getService(CohortDefinitionService.class).evaluate(sqlCohortDefinition, context);


		return new EvaluatedCohort(nvpForBabyANC, definition, context);
	}
}
