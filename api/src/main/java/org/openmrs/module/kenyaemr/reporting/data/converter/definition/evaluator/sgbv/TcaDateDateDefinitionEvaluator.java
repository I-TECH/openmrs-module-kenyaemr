...
/**
 * Evaluates TCA date DataDefinition
 */
@Handler(supports=TcaDateDataDefinition.class, order=50)
public class TcaDateDateDefinitionEvaluator implements EncounterDataEvaluator {
