...
/**
 * Evaluates Art Cohort TB Start DATE Data Definition
 */
@Handler(supports=TbStartDateArtDataDefinition.class, order=50)
public class TbStartDateArtDataEvaluator implements PersonDataEvaluator {
