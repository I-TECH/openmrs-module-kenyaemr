...
public class CACXCountyDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT t.patient_id, d.county from kenyaemr_etl.etl_cervical_cancer_screening t inner join kenyaemr_etl.etl_person_address d on t.patient_id = d.patient_id;";
