...
public class PublicHealthActionReportBuilder extends AbstractReportBuilder {
    ...
    protected DataSetDefinition publicHealthAction() {
        ...
        cohortDsd.addColumn("Children of HIV infected adults with undocumented HIV status", " (Please run Children contacts with undocumented HIV status for linelist)", ReportUtils.map(publicHealthActionIndicatorLibrary.childrenContactsUndocumentedHIVStatus(), "startDate=${startDate},endDate=${endDate}"), "");
