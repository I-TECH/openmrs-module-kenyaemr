...
public class MaternityClientsWithAPHCohortDefinition extends BaseQuery<Encounter> implements EncounterQuery {

    @ConfigurationProperty
    private Date asOfDate;

    public MaternityClientsWithAPHCohortDefinition() {
    }
