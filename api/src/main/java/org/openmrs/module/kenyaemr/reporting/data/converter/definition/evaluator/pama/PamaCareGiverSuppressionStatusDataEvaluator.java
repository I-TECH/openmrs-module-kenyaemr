 ...
 */
@Handler(supports= PamaCareGiverSuppressionStatusDataDefinition.class, order=50)
public class PamaCareGiverSuppressionStatusDataEvaluator implements PersonDataEvaluator {
