...
/**
 * Evaluates VMMCMethodDataDefinition to produce circumcision method
 */
@Handler(supports= VMMCMethodDataDefinition.class, order=50)
public class VMMCMethodDataEvaluator implements PersonDataEvaluator {
