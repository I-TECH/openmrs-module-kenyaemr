...
@Component
@Builds("kenyaemr.hiv.report.artCohortAnalysis36Months")
public class ArtCohortAnalysis36MonthsReportBuilder extends AbstractCohortReportBuilder {
	...
	protected Mapped<CohortDefinition> buildCohort(CohortReportDescriptor descriptor, PatientDataSetDefinition dsd) {
		CohortDefinition cd = artCohortLibrary.netCohortMonths(36);
