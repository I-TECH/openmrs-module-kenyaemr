...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.defaulterTracing.DateMissedAppointmentBeforeTracingDataDefinition;
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.defaulterTracing.LastVisitDateBeforeMissedAppointmentDataDefinition;
...
/**
 * Returns the last visit date before client missed appointment
 */
@Handler(supports= LastVisitDateBeforeMissedAppointmentDataDefinition.class, order=50)
public class LastVisitDateBeforeMissedAppointmentDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select b.encounter_id, b.lost_clinical_visit_date\n" +
