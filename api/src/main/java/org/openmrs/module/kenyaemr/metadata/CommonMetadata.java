...
public class CommonMetadata extends AbstractMetadataBundle {
	...
	public static final class _PatientIdentifierType {
		...
		public static final String PRISONER_ID = Metadata.IdentifierType.PRISONER_ID;
	}
	...
	public void install() {
		...
		install(patientIdentifierType("Prisoner ID", "Prisoner ID", "", "Allows for alphanumeric format",
				null, LocationBehavior.NOT_USED, false, _PatientIdentifierType.PRISONER_ID));
