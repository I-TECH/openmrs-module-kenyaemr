...
public class CommonMetadata extends AbstractMetadataBundle {
	...
	public static final class _VisitAttributeType {
		...
		public static final String PATIENT_TYPE_CONCEPT_UUID = "5282AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
		public static final String  PATIENT_METHOD_CONCEPT_UUID = "e6cb0c3b-04b0-4117-9bc6-ce24adbda802";
		...
		public static final String NON_PAYING_PATIENT_CATEGORY_CONCEPT_UUID = "df0362f9-782e-4d92-8bb2-3112e9e9eb3c";
	}
	...
	public void install() {
		...
		install(visitAttributeType("Patient Type", "To indicate whether the patient is paying for a service", ConceptDatatype.class, null, 0, 1, _VisitAttributeType.PATIENT_TYPE_CONCEPT_UUID));
		install(visitAttributeType("Payment Method", "The payment method used by the patient to settle payment", ConceptDatatype.class, null, 0, 1, _VisitAttributeType.PATIENT_METHOD_CONCEPT_UUID));
		...
		install(visitAttributeType("Non-Paying patient category", "If a patient isn't paying for service, The catergory the fall in.", ConceptDatatype.class, null, 0, 1, _VisitAttributeType.NON_PAYING_PATIENT_CATEGORY_CONCEPT_UUID));
