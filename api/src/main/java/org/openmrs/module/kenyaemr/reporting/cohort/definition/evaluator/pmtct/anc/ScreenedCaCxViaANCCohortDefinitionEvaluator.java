	...
	public class ScreenedCaCxViaANCCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
		...
		public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
			...
			String qry = "select distinct v.patient_id\n" +
					...
					"      and v.cacx_screening_method =162816;";
			...
			Cohort cacxVia = Context.getService(CohortDefinitionService.class).evaluate(sqlCohortDefinition, context);


			return new EvaluatedCohort(cacxVia, definition, context);
		}
	}
