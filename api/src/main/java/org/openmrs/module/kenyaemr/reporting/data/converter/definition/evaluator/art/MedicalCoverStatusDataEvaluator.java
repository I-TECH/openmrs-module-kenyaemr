...
/**
 * Evaluates MedicalCoverStatusDataDefinition
 */
@Handler(supports=MedicalCoverStatusDataDefinition.class, order=50)
public class MedicalCoverStatusDataEvaluator implements PersonDataEvaluator {
