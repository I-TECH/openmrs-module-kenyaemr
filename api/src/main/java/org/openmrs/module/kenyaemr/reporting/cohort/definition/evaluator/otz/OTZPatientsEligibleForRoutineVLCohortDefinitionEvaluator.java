...
import org.openmrs.module.kenyaemr.reporting.cohort.definition.otz.OTZPatientsEligibleForRoutineVLCohortDefinition;
...
/**
 * Evaluates a EligibleForRoutineVLDataDefinition
 */
@Handler(supports = {OTZPatientsEligibleForRoutineVLCohortDefinition.class})
public class OTZPatientsEligibleForRoutineVLCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
        ...
        Cohort eligibleForRoutineVL = Context.getService(CohortDefinitionService.class).evaluate(cd, context);


        return new EvaluatedCohort(eligibleForRoutineVL, definition, context);
    }
}
