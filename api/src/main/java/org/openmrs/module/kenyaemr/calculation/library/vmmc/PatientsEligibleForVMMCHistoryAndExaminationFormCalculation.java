 ...
 * Enrolled to VMMC
 * Has No vmmc prodedure done
 */
public class PatientsEligibleForVMMCHistoryAndExaminationFormCalculation extends AbstractPatientCalculation {

    protected static final Log log = LogFactory.getLog(PatientsEligibleForVMMCHistoryAndExaminationFormCalculation.class);
    ...
    public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> parameterValues, PatientCalculationContext context) {
        ...
        for(Integer ptId: cohort) {
            ...
            if (inVmmcProgram.contains(ptId) && lastVmmcProcedureEnc == null ) {
                    eligible = true;
              }
