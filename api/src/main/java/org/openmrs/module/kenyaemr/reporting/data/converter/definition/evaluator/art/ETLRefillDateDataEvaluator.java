...
/**
 * Evaluates Refill Data Definition
 */
@Handler(supports= ETLRefillDateDataDefinition.class, order=50)
public class ETLRefillDateDataEvaluator implements PersonDataEvaluator {
