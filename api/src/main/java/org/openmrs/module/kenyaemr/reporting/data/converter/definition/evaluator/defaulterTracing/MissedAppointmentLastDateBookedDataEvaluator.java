...
/**
 * Returns the date patient promised to come back
 */
@Handler(supports= MissedAppointmentLastDateBookedDataDefinition.class, order=50)
public class MissedAppointmentLastDateBookedDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select fup.encounter_id, max(date(tr.booking_date)) last_trace_date\n" +
