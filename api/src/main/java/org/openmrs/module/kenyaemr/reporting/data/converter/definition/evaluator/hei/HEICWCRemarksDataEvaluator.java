...
/**
 * Evaluates Current HEI Remarks to Data Definition
 */
@Handler(supports=HEICWCRemarksDataDefinition.class, order=50)
public class HEICWCRemarksDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select encounter_id,comments from kenyaemr_etl.etl_hei_follow_up_visit;";
