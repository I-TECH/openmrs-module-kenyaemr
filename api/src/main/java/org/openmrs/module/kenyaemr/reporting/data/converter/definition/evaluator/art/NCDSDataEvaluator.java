...
public class NCDSDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select ci.patient_id,\n" +
                ...
                "end SEPARATOR\n" +
                "','), group_concat(ci.chronic_illness_onset_date),\n" +
                "group_concat(case ci.is_chronic_illness_controlled when 1065 then 'Yes' when 1066 then 'No' end)) as ChronicIllness\n" +
