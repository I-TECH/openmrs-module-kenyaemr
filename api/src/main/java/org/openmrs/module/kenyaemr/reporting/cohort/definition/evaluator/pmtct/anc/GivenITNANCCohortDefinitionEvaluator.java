 ...
 */
@Handler(supports = {GivenITNANCCohortDefinition.class})
public class GivenITNANCCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		GivenITNANCCohortDefinition definition = (GivenITNANCCohortDefinition) cohortDefinition;
		String qry = "select\n" +
		...
		Cohort givenITNANC = Context.getService(CohortDefinitionService.class).evaluate(sqlCohortDefinition, context);


		return new EvaluatedCohort(givenITNANC, definition, context);
	}
}
