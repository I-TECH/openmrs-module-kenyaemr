...
public class OtzDiscontinuationVelocityCalculation extends BaseEmrCalculation {
    ...
    public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> parameterValues, PatientCalculationContext context) {
        ...
        for (Integer ptId : cohort) {
            ...
            List<PatientProgram> programs = service.getPatientPrograms(Context.getPatientService().getPatient(ptId), otzProgram, null, null, null,null, true);
            if (programs.size() > 0) {
