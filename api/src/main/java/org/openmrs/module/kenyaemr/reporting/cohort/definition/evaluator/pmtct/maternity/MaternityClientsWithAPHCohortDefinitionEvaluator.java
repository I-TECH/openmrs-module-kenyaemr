...
/**
 * Evaluator for Clients with APH
 */
@Handler(supports = {MaternityClientsWithAPHCohortDefinition.class})
public class MaternityClientsWithAPHCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
        ...
        Cohort clientsWithAPH = Context.getService(CohortDefinitionService.class).evaluate(sqlCohortDefinition, context);


        return new EvaluatedCohort(clientsWithAPH, definition, context);
    }
