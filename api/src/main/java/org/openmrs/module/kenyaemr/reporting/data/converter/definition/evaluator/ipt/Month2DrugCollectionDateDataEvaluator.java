...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.ipt.Month1DrugCollectionDateDataDefinition;
...
/**
 * Evaluates Month2DrugCollectionDateDataDefinition
 */
@Handler(supports= Month2DrugCollectionDateDataDefinition.class, order=50)
public class Month2DrugCollectionDateDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select init.patient_id, date(o.date_activated) as month2_refill from kenyaemr_etl.etl_ipt_initiation init left outer join openmrs.orders o on init.patient_id = o.patient_id\n" +
