...
public class VMMCRegisterReportBuilder extends AbstractHybridReportBuilder {
    ...
    protected PatientDataSetDefinition vmmcDataSetDefinition() {
        ...
        dsd.addColumn("Sub-County of Residence", new CalculationDataDefinition("Sub-County", new SubCountyAddressCalculation()), "", null);
        ...
        dsd.addColumn("Population Type", new VMMCLatestPopulationTypeDataDefinition(), "");
