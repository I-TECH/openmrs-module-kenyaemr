 ...
 */
package org.openmrs.module.kenyaemr.reporting.library.ipt;
...
public class IPTIndicatorLibrary {
	...
	public CohortIndicator numberOnIPT() {
		return cohortIndicator("No. on IPT", ReportUtils.<CohortDefinition>map(new NewClientsANCCohortDefinition(), ""));
	}
}