...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.ipt.Month6DrugCollectionDateDataDefinition;
...
public class Month6DrugCollectionDateDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select init.patient_id, date(o.date_activated) as month6_refill from kenyaemr_etl.etl_ipt_initiation init left outer join openmrs.orders o on init.patient_id = o.patient_id\n" +
                "                                                                                                          inner join openmrs.drug_order do on o.order_id = do.order_id\n" +
                "where o.concept_id = 78280 and o.date_activated between date_add(o.date_activated,INTERVAL 151 DAY) and date_add(o.date_activated,INTERVAL 180 DAY)\n" +
