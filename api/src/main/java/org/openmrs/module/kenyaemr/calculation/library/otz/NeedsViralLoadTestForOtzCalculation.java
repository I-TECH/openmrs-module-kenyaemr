...
/**
 * Created by Palladium on 10/01/2020.
 */
public class NeedsViralLoadTestForOtzCalculation extends AbstractPatientCalculation implements PatientFlagCalculation {
    ...
    public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> parameterValues, PatientCalculationContext context) {
        ...
        for(Integer ptId:cohort) {
            ...
            if(inHivProgram.contains(ptId) && onArt.contains(ptId) && inOtzProgram.contains(ptId) && !pendingVlResults.contains(ptId)){
