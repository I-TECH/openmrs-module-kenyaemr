...
/**
 * Evaluates a MchServiceDeliveryPointDataDefinition
 */
@Handler(supports = MchServiceDeliveryPointDataDefinition.class, order = 50)
public class MchServiceDeliveryPointDataEvaluator implements PersonDataEvaluator {
