...
public class PamaReportCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		String qry = "select t.patient_id\n" +
				...
				"join openmrs.relationship r on r.person_a = p.patient_id\n" +
				"join openmrs.relationship_type t on r.relationship = t.relationship_type_id and t.uuid = '3667e52f-8653-40e1-b227-a7278d474020' and (r.end_date is null or r.end_date > date(:endDate))\n" +
