...
/**
 * Evaluator for Clients who had assisted vaginal delivery
 */
@Handler(supports = {AssistedVaginalDeliveriesCohortDefinition.class})
public class MaternityAssistedVaginalDeliveriesCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
        ...
        Cohort assistedDelivery = Context.getService(CohortDefinitionService.class).evaluate(sqlCohortDefinition, context);


        return new EvaluatedCohort(assistedDelivery, definition, context);
    }
