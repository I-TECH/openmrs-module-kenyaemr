...
public class MaternityClientsWithRapturedUterusCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
        ...
        MaternityClientsWithRapturedUterusCohortDefinition definition = (MaternityClientsWithRapturedUterusCohortDefinition) cohortDefinition;

        if (definition == null)
            return null;

        String query = "select distinct patient_id from kenyaemr_etl.etl_mchs_delivery  where coded_delivery_complications =113195;";
