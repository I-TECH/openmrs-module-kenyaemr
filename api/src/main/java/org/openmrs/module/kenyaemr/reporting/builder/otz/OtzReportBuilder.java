...
public class OtzReportBuilder extends AbstractReportBuilder {
    ...
    protected DataSetDefinition trackingSuspectedTreatmentFailureDataSet() {
        ...
        EmrReportingUtils.addRow(cohortDsd, "ALHIV", "Total number of ALHIV in OTZ with VL > 1000 copies/ml at enrolment (cohort reporting month 6)", ReportUtils.map(otzIndicators.patientWithVLMoreThan1000AtEnrollment(6), indParams), AdolecenceStandardDisaggregationAgeAndSex, Arrays.asList("123", "124"));
        ...
        EmrReportingUtils.addRow(cohortDsd, "ALHIV", "Total number of ALHIV in OTZ with VL > 1000 copies/ml (cohort reporting month 12)", ReportUtils.map(otzIndicators.patientWithVLMoreThan1000AtEnrollment(12), indParams), AdolecenceStandardDisaggregationAgeAndSex, Arrays.asList("139", "140"));
        ...
        EmrReportingUtils.addRow(cohortDsd, "ALHIV", "Total number of ALHIV in OTZ with VL > 1000 copies/ml (cohort reporting month 18)", ReportUtils.map(otzIndicators.patientWithVLMoreThan1000AtEnrollment(18), indParams), AdolecenceStandardDisaggregationAgeAndSex, Arrays.asList("155", "156"));
        ...
        EmrReportingUtils.addRow(cohortDsd, "ALHIV", "Total number of ALHIV in OTZ with VL > 1000 copies/ml (cohort reporting month 24)", ReportUtils.map(otzIndicators.patientWithVLMoreThan1000AtEnrollment(24), indParams), AdolecenceStandardDisaggregationAgeAndSex, Arrays.asList("171", "172"));
    ...
    protected DataSetDefinition continuingServicesDataSet() {
        ...
        EmrReportingUtils.addRow(cohortDsd, "ALHIV", "Total youth aged 20-24yrs and still in OTZ who had valid viral load results during the reporting period (cohort reporting month 6)", ReportUtils.map(otzIndicators.patients20To24WithValidVLOnReportingPeriod(6), indParams), AdultsStandardDisaggregationAgeAndSex, Arrays.asList("043", "044"));
        EmrReportingUtils.addRow(cohortDsd, "ALHIV", "Total Youths aged 20-24yrs in OTZ who had valid viral load results <1000 copies/ml (cohort reporting month 6)", ReportUtils.map(otzIndicators.patients20To24WithValidVLLess1000(6), indParams), AdultsStandardDisaggregationAgeAndSex, Arrays.asList("045", "046"));
        EmrReportingUtils.addRow(cohortDsd, "ALHIV", "Total Youths aged 20-24yrs in OTZ who had valid viral load results <400 copies/ml (cohort reporting month 6)", ReportUtils.map(otzIndicators.patients20To24WithValidVLLess400(6), indParams), AdultsStandardDisaggregationAgeAndSex, Arrays.asList("047", "048"));
        ...
        EmrReportingUtils.addRow(cohortDsd, "ALHIV", "Total youth aged 20-24yrs and still in OTZ who had valid viral load results during the reporting period (cohort reporting month 12)", ReportUtils.map(otzIndicators.patients20To24WithValidVLOnReportingPeriod(12), indParams), AdultsStandardDisaggregationAgeAndSex, Arrays.asList("053", "054"));
        EmrReportingUtils.addRow(cohortDsd, "ALHIV", "Total Youths aged 20-24yrs in OTZ who had valid viral load results <1000 copies/ml (cohort reporting month 12)", ReportUtils.map(otzIndicators.patients20To24WithValidVLLess1000(12), indParams), AdultsStandardDisaggregationAgeAndSex, Arrays.asList("055", "056"));
        EmrReportingUtils.addRow(cohortDsd, "ALHIV", "Total Youths aged 20-24yrs in OTZ who had valid viral load results <400 copies/ml (cohort reporting month 12)", ReportUtils.map(otzIndicators.patients20To24WithValidVLLess400(12), indParams), AdultsStandardDisaggregationAgeAndSex, Arrays.asList("057", "058"));
        ...
        EmrReportingUtils.addRow(cohortDsd, "ALHIV", "Total youth aged 20-24yrs and still in OTZ who had valid viral load results during the reporting period (cohort reporting month 18)", ReportUtils.map(otzIndicators.patients20To24WithValidVLOnReportingPeriod(18), indParams), AdultsStandardDisaggregationAgeAndSex, Arrays.asList("063", "064"));
        EmrReportingUtils.addRow(cohortDsd, "ALHIV", "Total Youths aged 20-24yrs in OTZ who had valid viral load results <1000 copies/ml (cohort reporting month 18)", ReportUtils.map(otzIndicators.patients20To24WithValidVLLess1000(18), indParams), AdultsStandardDisaggregationAgeAndSex, Arrays.asList("065", "066"));
        EmrReportingUtils.addRow(cohortDsd, "ALHIV", "Total Youths aged 20-24yrs in OTZ who had valid viral load results <400 copies/ml (cohort reporting month 18)", ReportUtils.map(otzIndicators.patients20To24WithValidVLLess400(18), indParams), AdultsStandardDisaggregationAgeAndSex, Arrays.asList("067", "068"));
        ...
        EmrReportingUtils.addRow(cohortDsd, "ALHIV", "Total youth aged 20-24yrs and still in OTZ who had valid viral load results during the reporting period (cohort reporting month 24)", ReportUtils.map(otzIndicators.patients20To24WithValidVLOnReportingPeriod(24), indParams), AdultsStandardDisaggregationAgeAndSex, Arrays.asList("073", "074"));
        EmrReportingUtils.addRow(cohortDsd, "ALHIV", "Total Youths aged 20-24yrs in OTZ who had valid viral load results <1000 copies/ml (cohort reporting month 24)", ReportUtils.map(otzIndicators.patients20To24WithValidVLLess1000(24), indParams), AdultsStandardDisaggregationAgeAndSex, Arrays.asList("075", "076"));
        EmrReportingUtils.addRow(cohortDsd, "ALHIV", "Total Youths aged 20-24yrs in OTZ who had valid viral load results <400 copies/ml (cohort reporting month 24)", ReportUtils.map(otzIndicators.patients20To24WithValidVLLess400(24), indParams), AdultsStandardDisaggregationAgeAndSex, Arrays.asList("077", "078"));
