 ...
 */
public class PatientsEligibleForHtsInitialTestCalculation extends AbstractPatientCalculation {

    protected static final Log log = LogFactory.getLog(PatientsEligibleForHtsInitialTestCalculation.class);
    ...
    public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> parameterValues, PatientCalculationContext context) {
        ...
        for(Integer ptId: cohort){
            ...
            boolean noTestingHistory = false;
            ...
            List<Encounter> htsEncounters = Context.getEncounterService().getEncounters(patient, null, null, null, Arrays.asList(htsInitialForm, htsRetestForm), null, null, null, null, false);

            if(enrollmentEncounters.size() <= 0 && htsEncounters.size() <=0) {
                noTestingHistory = true;
            }
