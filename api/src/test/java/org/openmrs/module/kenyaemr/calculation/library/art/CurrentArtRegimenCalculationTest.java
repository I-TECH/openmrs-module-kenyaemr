...
import org.openmrs.module.kenyaemr.calculation.library.art.CurrentArtRegimenCalculation;
...
public class CurrentArtRegimenCalculationTest extends BaseModuleContextSensitiveTest {
	...
	/**
	 * @see org.openmrs.module.kenyaemr.calculation.library.art.CurrentArtRegimenCalculation#evaluate(java.util.Collection, java.util.Map, org.openmrs.calculation.patient.PatientCalculationContext)
	 */
	@Test
