...
public class OnArtCalculationTest extends BaseModuleContextSensitiveTest {
	...
	/**
	 * @see org.openmrs.module.kenyaemr.calculation.art.CurrentArtRegimenCalculation#evaluate(java.util.Collection, java.util.Map, org.openmrs.calculation.patient.PatientCalculationContext)
	 */
	@Test
