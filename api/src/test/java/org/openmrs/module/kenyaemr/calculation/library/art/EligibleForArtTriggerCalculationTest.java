...
import org.openmrs.module.kenyaemr.calculation.library.art.EligibleForArtTriggerCalculation;
...
public class EligibleForArtTriggerCalculationTest extends BaseModuleContextSensitiveTest {
	...
	/**
	 * @see org.openmrs.module.kenyaemr.calculation.library.art.EligibleForArtTriggerCalculation#evaluate(java.util.Collection, java.util.Map, org.openmrs.calculation.patient.PatientCalculationContext)
