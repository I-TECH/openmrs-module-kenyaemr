...
public class OneMonthCohortCalculationTest extends BaseModuleContextSensitiveTest{
	...
	public void testEvaluate() throws Exception {
		...
		CalculationResultMap resultMap = new OneMonthCohortCalculation().evaluate(cohort, null, context);
		Assert.assertEquals(0, resultMap.keySet().size());
	}
}