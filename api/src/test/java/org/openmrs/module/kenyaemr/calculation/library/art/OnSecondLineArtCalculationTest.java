...
public class OnSecondLineArtCalculationTest extends BaseModuleContextSensitiveTest {
	...
	/**
	 * @see org.openmrs.module.kenyaemr.calculation.library.art.OnSecondLineArtCalculation#evaluate(java.util.Collection, java.util.Map, org.openmrs.calculation.patient.PatientCalculationContext)
	 */
	@Test
